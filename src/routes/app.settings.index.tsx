...
function SettingsPage() {
  ...
  const handleSignOut = async () => {
    markLocked();
    // Wipe all per-account caches so the next signed-in user never sees them.
    queryClient.clear();
    ...
    <div className="space-y-2 animate-in fade-in duration-300">
      ...
      <Card className="p-1.5 flex items-center gap-2">
        ...
        <div className="flex-1 min-w-0">
          <div className="font-bold text-[11.5px] truncate leading-tight">
            {displayName || "ضيف"}
          </div>
      ...
      <SettingsGroup title="الحساب">
        ...
        <SettingsRow
          ...
          icon={Bell}
          label="الإشعارات"
          desc="تذكيرات الاستحقاقات والديون"
          tone="warning"
        />
        <SettingsRow
          ...
          icon={Radio}
          label="قنوات التذكير"
          desc="واتساب، تليجرام، SMS وسياسة المتابعة"
          tone="success"
        />
      </SettingsGroup>
        ...
        <Card className="border-0 shadow-none p-1 flex items-center justify-between">
          <div className="flex items-center gap-1.5">
            ...
            <div>
              ...
              <div className="text-[10.5px] text-muted-foreground">تبديل سريع</div>
            </div>
          </div>
