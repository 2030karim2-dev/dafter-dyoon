...
import { playAlertSound, setSoundEnabled, soundEnabled, type AlertSound } from "@/lib/alert-sound";
...
const SEEN_KEY = "daftarak.alert.seenIds";
...
const soundFor = (item: PendingItem): AlertSound =>
  item.kind === "overdue" ? "overdue" : "reminder";
          ...
          >
            <span
              className={`size-7 shrink-0 rounded-lg flex items-center justify-center ring-1 ${
                overdue ? "bg-danger/15 ring-danger/30" : "bg-primary/10 text-primary ring-primary/25"
              }`}
            >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[9.5px] opacity-80 tabular-nums">
