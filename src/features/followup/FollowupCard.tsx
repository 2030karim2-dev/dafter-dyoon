  ...
  return (
    <div className={`rounded-lg border bg-card shadow-card p-2.5 space-y-2 ring-1 ${meta.ring}`}>
      ...
      <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[10.5px] text-muted-foreground">
        ...
        {b.daysOverdue >= 0 && (
          <span className="flex items-center gap-1">
            <Clock className="size-3" />{b.daysOverdue === 0 ? "يستحق اليوم" : `متأخر ${b.daysOverdue} يوم`}
          </span>
        )}
      ...
      <div className="flex gap-1.5">
        <Button size="sm" variant="outline" className="h-7 px-2 text-[11px] flex-1" onClick={() => onDraft(b)}>
