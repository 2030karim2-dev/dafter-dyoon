  ...
  return (
    <div className="bg-gradient-primary text-primary-foreground rounded-xl p-2.5 shadow-elevated">
      <div className="flex items-center justify-between text-[10px] opacity-85 mb-1">
        ...
        <Link
          to="/app/followup"
          className="flex items-center gap-1 bg-white/15 backdrop-blur px-1.5 py-0.5 rounded-full hover:bg-white/25 transition-colors text-[9px]"
        >
      ...
      <div className="grid grid-cols-2 gap-1.5">
        ...
        >
          <div className="flex items-center gap-1 text-[9px] opacity-90 mb-0.5">
      ...
      <div className="flex items-center justify-between mt-1 text-[9px] opacity-85 px-0.5">
        ...
        <span>
          {peopleCount} شخص · {txCount} معاملة
        </span>
      </div>
    </div>
  );
